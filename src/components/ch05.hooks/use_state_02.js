...
function App() {
    const imageSize = 120; // 이미즈 사이즈

    /* 관리해야 할 상태(state) 정의 */
    const [color, setColor] = useState('blue'); // 차량 생삭 영문 이름
    ...
    const [modelName, setModelName] = useState('아반떼(avante)'); // 한글 이름과 함꼐 보여줄 state
