function App() {
    ...
    return (
        <div className="App">
            ...
            {/* 해당 버튼을 클릭했을 떄 ClickEvent01 함수가 동작합니다.  */}
            <button onClick={ClickEvent01}>매개 변수 0 개</button><br />

            {/* 매개 변수가 있는 경우 화살표 함수로 둘러 싸야 합니다. */}
            <button onClick={() => ClickEvent02('김규식')}>매개 변수 1 개</button><br />

            {/* 2개의 정수를 더해주는 이벤트 구현 */}
            <button onClick={() => ClickEvent03(14, 5)}>매개 변수 2 개</button><br />
